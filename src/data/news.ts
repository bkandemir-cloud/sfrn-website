...
export const news: NewsPost[] = [
  {
    ...
    excerpt:
      'We are launching SFRN with an introductory webinar on Wednesday 23 September 2026, 4.00–5.00pm, including a conversation with Professor Sabine Little on sharing and publishing work as an under-18 researcher.',
    content: `We're launching SFRN with an introductory webinar on Wednesday 23 September 2026, 4.00–5.00pm. Come and find out what the Network is, who it's for, at every stage from the simply curious to those with work to share, and how to take part.
